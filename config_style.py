...
class Ui_Config(object):
    def setupUi(self, Config):
        ...
        self.scrollArea.setGeometry(QtCore.QRect(-10, 0, 471, 563))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 450, 1240))
        ...
        self.Label_MasterTitle.setGeometry(QtCore.QRect(20, 10, 311, 31))
        font = QtGui.QFont()
        ...
        self.TransSource = QtWidgets.QFrame(parent=self.scrollAreaWidgetContents)
        self.TransSource.setGeometry(QtCore.QRect(10, 670, 441, 291))
        self.TransSource.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.TransSource.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.TransSource.setObjectName("TransSource")
        self.PushButton_SourceUP = QtWidgets.QPushButton(parent=self.TransSource)
        self.PushButton_SourceUP.setGeometry(QtCore.QRect(320, 260, 51, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.Label_SelectableSource = QtWidgets.QLabel(parent=self.TransSource)
        self.Label_SelectableSource.setGeometry(QtCore.QRect(10, 60, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        ...
        self.PushButton_SourceDisable = QtWidgets.QPushButton(parent=self.TransSource)
        self.PushButton_SourceDisable.setGeometry(QtCore.QRect(350, 60, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.PushButton_SourceEnable = QtWidgets.QPushButton(parent=self.TransSource)
        self.PushButton_SourceEnable.setGeometry(QtCore.QRect(130, 60, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.Label_SourceSort = QtWidgets.QLabel(parent=self.TransSource)
        self.Label_SourceSort.setGeometry(QtCore.QRect(230, 260, 81, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        self.Label_SourceSort.setFont(font)
        self.Label_SourceSort.setObjectName("Label_SourceSort")
        self.Label_SourceTips = QtWidgets.QLabel(parent=self.TransSource)
        self.Label_SourceTips.setGeometry(QtCore.QRect(10, 260, 131, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.Label_SourceTips.setFont(font)
        self.Label_SourceTips.setObjectName("Label_SourceTips")
        self.Label_SelectedSource = QtWidgets.QLabel(parent=self.TransSource)
        self.Label_SelectedSource.setGeometry(QtCore.QRect(230, 60, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(12)
        ...
        self.PushButton_SourceDown = QtWidgets.QPushButton(parent=self.TransSource)
        self.PushButton_SourceDown.setGeometry(QtCore.QRect(380, 260, 51, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.ListWidget_SelectedSource = QtWidgets.QListWidget(parent=self.TransSource)
        self.ListWidget_SelectedSource.setGeometry(QtCore.QRect(230, 85, 201, 171))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.ListWidget_SelectableSource = QtWidgets.QListWidget(parent=self.TransSource)
        self.ListWidget_SelectableSource.setGeometry(QtCore.QRect(10, 85, 201, 171))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.Label_TranslatorSourcesSetting = QtWidgets.QLabel(parent=self.TransSource)
        self.Label_TranslatorSourcesSetting.setGeometry(QtCore.QRect(10, 30, 151, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        ...
        self.Line_Source = QtWidgets.QFrame(parent=self.TransSource)
        self.Line_Source.setGeometry(QtCore.QRect(210, 85, 21, 171))
        ...
        self.Line_3 = QtWidgets.QFrame(parent=self.TransSource)
        self.Line_3.setGeometry(QtCore.QRect(0, 10, 441, 21))
        self.Line_3.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.Line_3.setLineWidth(2)
        self.Line_3.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.Line_3.setObjectName("Line_3")
        self.PushButton_SourceUP.raise_()
        self.Label_SourceSort.raise_()
        self.Label_SourceTips.raise_()
        self.PushButton_SourceDown.raise_()
        self.ListWidget_SelectedSource.raise_()
        self.ListWidget_SelectableSource.raise_()
        self.Label_TranslatorSourcesSetting.raise_()
        self.Line_Source.raise_()
        self.Line_3.raise_()
        self.Label_SelectedSource.raise_()
        self.Label_SelectableSource.raise_()
        self.PushButton_SourceDisable.raise_()
        self.PushButton_SourceEnable.raise_()
        self.OCR_API = QtWidgets.QFrame(parent=self.scrollAreaWidgetContents)
        self.OCR_API.setGeometry(QtCore.QRect(9, 959, 441, 181))
        self.OCR_API.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.OCR_API.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.OCR_API.setObjectName("OCR_API")
        self.LineEdit_OCRKEY = QtWidgets.QLineEdit(parent=self.OCR_API)
        self.LineEdit_OCRKEY.setGeometry(QtCore.QRect(20, 140, 411, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        ...
        self.Line_4 = QtWidgets.QFrame(parent=self.OCR_API)
        self.Line_4.setGeometry(QtCore.QRect(0, 0, 441, 21))
        self.Line_4.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.Line_4.setLineWidth(2)
        self.Line_4.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.Line_4.setObjectName("Line_4")
        self.Label_OCRAPISetting = QtWidgets.QLabel(parent=self.OCR_API)
        self.Label_OCRAPISetting.setGeometry(QtCore.QRect(10, 30, 221, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(16)
        font.setUnderline(False)
        ...
        self.PushButton_GetFreeOCRKEY = QtWidgets.QPushButton(parent=self.OCR_API)
        self.PushButton_GetFreeOCRKEY.setGeometry(QtCore.QRect(330, 40, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.LineEdit_OCRSECRET = QtWidgets.QLineEdit(parent=self.OCR_API)
        self.LineEdit_OCRSECRET.setGeometry(QtCore.QRect(20, 110, 411, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        ...
        self.Label_XunFei = QtWidgets.QLabel(parent=self.OCR_API)
        self.Label_XunFei.setGeometry(QtCore.QRect(20, 60, 131, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        self.Label_XunFei.setFont(font)
        self.Label_XunFei.setObjectName("Label_XunFei")
        self.LineEdit_OCRAPPID = QtWidgets.QLineEdit(parent=self.OCR_API)
        self.LineEdit_OCRAPPID.setGeometry(QtCore.QRect(20, 80, 411, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        ...
        self.Opacity = QtWidgets.QFrame(parent=self.scrollAreaWidgetContents)
        self.Opacity.setEnabled(True)
        self.Opacity.setGeometry(QtCore.QRect(10, 1139, 441, 91))
        self.Opacity.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.Opacity.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.Opacity.setObjectName("Opacity")
        self.horizontalSlider_Opacity = QtWidgets.QSlider(parent=self.Opacity)
        self.horizontalSlider_Opacity.setGeometry(QtCore.QRect(190, 60, 241, 22))
        ...
        self.Label_XunFei_2 = QtWidgets.QLabel(parent=self.Opacity)
        self.Label_XunFei_2.setGeometry(QtCore.QRect(20, 60, 111, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        self.Label_XunFei_2.setFont(font)
        self.Label_XunFei_2.setObjectName("Label_XunFei_2")
        self.spinBox_Opacity = QtWidgets.QSpinBox(parent=self.Opacity)
        self.spinBox_Opacity.setGeometry(QtCore.QRect(140, 60, 42, 22))
        ...
        self.Label_OpacitySetting = QtWidgets.QLabel(parent=self.Opacity)
        self.Label_OpacitySetting.setGeometry(QtCore.QRect(10, 30, 221, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(16)
        font.setUnderline(False)
        ...
        self.Line_5 = QtWidgets.QFrame(parent=self.Opacity)
        self.Line_5.setGeometry(QtCore.QRect(0, 0, 441, 21))
        self.Line_5.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.Line_5.setLineWidth(2)
        self.Line_5.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.Line_5.setObjectName("Line_5")
        self.Hotkey = QtWidgets.QFrame(parent=self.scrollAreaWidgetContents)
        self.Hotkey.setGeometry(QtCore.QRect(10, 570, 441, 111))
        self.Hotkey.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.Hotkey.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.Hotkey.setObjectName("Hotkey")
        self.Line_2 = QtWidgets.QFrame(parent=self.Hotkey)
        self.Line_2.setGeometry(QtCore.QRect(0, 0, 441, 21))
        self.Line_2.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.Line_2.setLineWidth(2)
        self.Line_2.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.Line_2.setObjectName("Line_2")
        self.Label_HotkeySetting = QtWidgets.QLabel(parent=self.Hotkey)
        self.Label_HotkeySetting.setGeometry(QtCore.QRect(10, 20, 111, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(16)
        font.setUnderline(False)
        ...
        self.changeHotKeyButton = QtWidgets.QPushButton(parent=self.Hotkey)
        self.changeHotKeyButton.setGeometry(QtCore.QRect(260, 50, 41, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        ...
        self.cancelHotKeyButton = QtWidgets.QPushButton(parent=self.Hotkey)
        self.cancelHotKeyButton.setGeometry(QtCore.QRect(310, 50, 41, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        ...
        self.Label_ConcatHotkey = QtWidgets.QLabel(parent=self.Hotkey)
        self.Label_ConcatHotkey.setGeometry(QtCore.QRect(20, 80, 71, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        self.Label_ConcatHotkey.setFont(font)
        self.Label_ConcatHotkey.setObjectName("Label_ConcatHotkey")
        self.Label_ShortcutKeyText = QtWidgets.QLabel(parent=self.Hotkey)
        self.Label_ShortcutKeyText.setGeometry(QtCore.QRect(90, 50, 161, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        ...
        self.confirmHotKeyButton = QtWidgets.QPushButton(parent=self.Hotkey)
        self.confirmHotKeyButton.setGeometry(QtCore.QRect(260, 50, 41, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        ...
        self.Label_OCRHotkey = QtWidgets.QLabel(parent=self.Hotkey)
        self.Label_OCRHotkey.setGeometry(QtCore.QRect(20, 50, 71, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        self.Label_OCRHotkey.setFont(font)
        self.Label_OCRHotkey.setObjectName("Label_OCRHotkey")
        self.Label_ConcatShortcutKeyText = QtWidgets.QLabel(parent=self.Hotkey)
        self.Label_ConcatShortcutKeyText.setGeometry(QtCore.QRect(90, 80, 161, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        font.setUnderline(True)
        ...
        self.changeConcatHotKeyButton = QtWidgets.QPushButton(parent=self.Hotkey)
        self.changeConcatHotKeyButton.setGeometry(QtCore.QRect(260, 80, 41, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        ...
        self.confirmConcatHotKeyButton = QtWidgets.QPushButton(parent=self.Hotkey)
        self.confirmConcatHotKeyButton.setGeometry(QtCore.QRect(260, 80, 41, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        ...
        self.OCRKeyEdit = oneKeyQKeySequenceEdit(parent=self.Hotkey)
        self.OCRKeyEdit.setGeometry(QtCore.QRect(90, 50, 161, 20))
        self.OCRKeyEdit.setKeySequence("")
        self.OCRKeyEdit.setObjectName("OCRKeyEdit")
        self.cancelConcatHotKeyButton = QtWidgets.QPushButton(parent=self.Hotkey)
        self.cancelConcatHotKeyButton.setGeometry(QtCore.QRect(310, 80, 41, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        ...
        self.ConcatKeyEdit = oneKeyQKeySequenceEdit(parent=self.Hotkey)
        self.ConcatKeyEdit.setGeometry(QtCore.QRect(90, 80, 161, 20))
        self.ConcatKeyEdit.setKeySequence("")
        self.ConcatKeyEdit.setObjectName("ConcatKeyEdit")
        self.API_KEY = QtWidgets.QFrame(parent=self.scrollAreaWidgetContents)
        self.API_KEY.setGeometry(QtCore.QRect(9, 39, 441, 521))
        self.API_KEY.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.API_KEY.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.API_KEY.setObjectName("API_KEY")
        self.LineEdit_OpenaiAPI = QtWidgets.QLineEdit(parent=self.API_KEY)
        self.LineEdit_OpenaiAPI.setGeometry(QtCore.QRect(20, 490, 411, 25))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        self.LineEdit_OpenaiAPI.setFont(font)
        self.LineEdit_OpenaiAPI.setFocusPolicy(QtCore.Qt.FocusPolicy.ClickFocus)
        self.LineEdit_OpenaiAPI.setReadOnly(False)
        self.LineEdit_OpenaiAPI.setObjectName("LineEdit_OpenaiAPI")
        self.Line_1 = QtWidgets.QFrame(parent=self.API_KEY)
        self.Line_1.setGeometry(QtCore.QRect(0, 0, 441, 20))
        ...
        self.LineEdit_YoudaoSECRET = QtWidgets.QLineEdit(parent=self.API_KEY)
        self.LineEdit_YoudaoSECRET.setGeometry(QtCore.QRect(20, 95, 411, 25))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.CheckBox_Tencent = QtWidgets.QCheckBox(parent=self.API_KEY)
        self.CheckBox_Tencent.setEnabled(False)
        self.CheckBox_Tencent.setGeometry(QtCore.QRect(320, 260, 111, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.LineEdit_YoudaoKEY = QtWidgets.QLineEdit(parent=self.API_KEY)
        self.LineEdit_YoudaoKEY.setGeometry(QtCore.QRect(20, 70, 411, 25))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.Label_Youdao = QtWidgets.QLabel(parent=self.API_KEY)
        ...
        self.Label_Baidu = QtWidgets.QLabel(parent=self.API_KEY)
        self.Label_Baidu.setGeometry(QtCore.QRect(20, 180, 91, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        self.Label_Baidu.setFont(font)
        self.Label_Baidu.setObjectName("Label_Baidu")
        self.CheckBox_Baidu = QtWidgets.QCheckBox(parent=self.API_KEY)
        self.CheckBox_Baidu.setGeometry(QtCore.QRect(320, 180, 111, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.CheckBox_CaiYun = QtWidgets.QCheckBox(parent=self.API_KEY)
        self.CheckBox_CaiYun.setGeometry(QtCore.QRect(320, 130, 111, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.LineEdit_AliYunKEY = QtWidgets.QLineEdit(parent=self.API_KEY)
        self.LineEdit_AliYunKEY.setGeometry(QtCore.QRect(20, 410, 411, 25))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.Label_CaiYun = QtWidgets.QLabel(parent=self.API_KEY)
        self.Label_CaiYun.setGeometry(QtCore.QRect(20, 130, 91, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        self.Label_CaiYun.setFont(font)
        self.Label_CaiYun.setObjectName("Label_CaiYun")
        self.Label_Openai = QtWidgets.QLabel(parent=self.API_KEY)
        self.Label_Openai.setGeometry(QtCore.QRect(20, 470, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        self.Label_Openai.setFont(font)
        self.Label_Openai.setObjectName("Label_Openai")
        self.LineEdit_TencentSECRET = QtWidgets.QLineEdit(parent=self.API_KEY)
        self.LineEdit_TencentSECRET.setGeometry(QtCore.QRect(20, 305, 411, 25))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.Label_AliYun = QtWidgets.QLabel(parent=self.API_KEY)
        self.Label_AliYun.setGeometry(QtCore.QRect(20, 390, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        self.Label_AliYun.setFont(font)
        self.Label_AliYun.setObjectName("Label_AliYun")
        self.LineEdit_BaiduAPPID = QtWidgets.QLineEdit(parent=self.API_KEY)
        self.LineEdit_BaiduAPPID.setGeometry(QtCore.QRect(20, 200, 411, 25))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.LineEdit_BaiduSECRETKEY = QtWidgets.QLineEdit(parent=self.API_KEY)
        self.LineEdit_BaiduSECRETKEY.setGeometry(QtCore.QRect(20, 225, 411, 25))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.CheckBox_Youdao = QtWidgets.QCheckBox(parent=self.API_KEY)
        self.CheckBox_Youdao.setGeometry(QtCore.QRect(320, 50, 111, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.LineEdit_XiaoNiuKEY = QtWidgets.QLineEdit(parent=self.API_KEY)
        self.LineEdit_XiaoNiuKEY.setGeometry(QtCore.QRect(20, 360, 411, 25))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.Label_TranslatorAPISecretSetting = QtWidgets.QLabel(parent=self.API_KEY)
        self.Label_TranslatorAPISecretSetting.setGeometry(QtCore.QRect(10, 20, 171, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        ...
        self.Label_XiaoNiu = QtWidgets.QLabel(parent=self.API_KEY)
        self.Label_XiaoNiu.setGeometry(QtCore.QRect(20, 340, 91, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        self.Label_XiaoNiu.setFont(font)
        self.Label_XiaoNiu.setObjectName("Label_XiaoNiu")
        self.LineEdit_CaiYunTOKEN = QtWidgets.QLineEdit(parent=self.API_KEY)
        self.LineEdit_CaiYunTOKEN.setGeometry(QtCore.QRect(20, 150, 411, 25))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.LineEdit_AliYunSECRET = QtWidgets.QLineEdit(parent=self.API_KEY)
        self.LineEdit_AliYunSECRET.setGeometry(QtCore.QRect(20, 435, 411, 25))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.Label_Tencent = QtWidgets.QLabel(parent=self.API_KEY)
        self.Label_Tencent.setGeometry(QtCore.QRect(20, 260, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        self.Label_Tencent.setFont(font)
        self.Label_Tencent.setObjectName("Label_Tencent")
        self.Label_HelpLink = QtWidgets.QLabel(parent=self.API_KEY)
        self.Label_HelpLink.setGeometry(QtCore.QRect(340, 20, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.LineEdit_TencentKEY = QtWidgets.QLineEdit(parent=self.API_KEY)
        self.LineEdit_TencentKEY.setGeometry(QtCore.QRect(20, 280, 411, 25))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.Opacity.raise_()
        self.OCR_API.raise_()
        self.TransSource.raise_()
        self.Label_MasterTitle.raise_()
    ...
    def retranslateUi(self, Config):
        ...
        self.LineEdit_OpenaiAPI.setPlaceholderText(_translate("Config", "请输入OpenAI API_KEY"))
        ...
        self.Label_Openai.setText(_translate("Config", "ChatGPT API"))
